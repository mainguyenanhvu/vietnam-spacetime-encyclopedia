...
- [x] Icon vẽ tay I01–I06 cho 7 lớp nhân vật ở chế độ 2D (2026-09-23), `src/icon-ve-tay.ts`: path SVG vẽ bằng `Path2D`, đồng bộ nên không có lúc lớp đòi ảnh chưa giải mã. Rút gọn so với đặc tả vì icon chỉ 16px: vương miện bỏ rồng, sao bỏ bóng súng. Nhãn chữ ở bảng lớp/popup vẫn là emoji. Các lớp phủ còn lại vẫn dùng emoji — thêm lớp nào thì thêm một khoá vào `ICON_VE_TAY`.
- [ ] Smoke S7 bắt được **0 request** `/data/` (không phải tải thừa — phép đo mù), hỏng cả trên code gốc 2026-09-23 lúc chạy riêng; sáng cùng ngày còn đạt. Sửa bộ đo, đừng nới ngưỡng. **S**
