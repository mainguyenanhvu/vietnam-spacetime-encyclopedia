...
| 10 | Sa đồ chiến dịch | 🔄 **96/189 — TOÀN BỘ TRƯỚC THẾ KỶ XX ĐÃ PHỦ.** Trình dựng SVG tổng quát chạy bằng dữ liệu (soạn sa đồ mới chỉ còn là viết JSON); bản vẽ tay Bạch Đằng giữ nguyên; `battles/_index.json` sinh tự động + cổng chống mốc. 5 đợt, không đợt nào phải quay lại sửa nội dung. Đo 93 trận còn lại: **88 nằm ở TK20**, trước đó chỉ còn 5 mục — 2 trong đó là hai mục người soạn CHỦ ĐỘNG BỎ vì chất lượng (Hội thề Lũng Nhai không chép trong ĐVSKTT; Lê–Trịnh Bắc phạt không có điểm giao tranh trung tâm), 3 mục còn lại không phải trận đánh dựng được diễn biến (hội nghị Bình Than, nơi ban Chiếu Cần Vương, mục thứ hai cho khởi nghĩa Hai Bà Trưng). |
...
🔴 **LỚP TRẬN ĐÁNH LỆCH NẶNG VỀ THẾ KỶ XX — trần của mục tiêu #9.** Đo 2026-08-05 trên 189 mục `overlays/chien-dich-tran-danh.json`: TK1 2 · TK3 1 · TK6 2 · TK8 2 · TK10 5 · TK11 3 · TK13 8 · TK14 2 · TK15 10 · TK16 2 · TK17 4 · TK18 6 · TK19 18 · **TK20 124 (66 %)**. Nặng nhất: cả giai đoạn **1789–1858 chỉ có ĐÚNG MỘT mục**, và các khởi nghĩa nông dân thời Nguyễn (Phan Bá Vành, Nông Văn Vân, Lê Văn Khôi, Cao Bá Quát) **không có mục nào** — đã grep xác nhận. Mục tiêu «học toàn bộ trận đánh 4000 năm qua sa đồ» KHÔNG đạt được bằng cách vẽ thêm sa đồ; trần nằm ở lớp dữ liệu nguồn. Đang có đợt soạn ≥60 mục lấp trống, ưu tiên Nguyễn 1802–1858 → Tây Sơn cuối → các thế kỷ 1–4 mục.

⚠️ **Trùng toạ độ KHÍT làm một mục biến mất ở 3D.** `main.ts` khử trùng mô hình theo khoá toạ độ làm tròn 5 chữ số — hai mục cùng toạ độ chỉ dựng MỘT mô hình. Không cổng nào bắt được: dữ liệu hợp lệ hoàn toàn, chỉ là một mục âm thầm vô hình. Bắt được 2026-08-05 khi mục mới «Xiêm chiếm Hà Tiên 1833» trùng đúng 0 m với «bảo vệ biên giới Hà Tiên 1975–1979». Khi hai sự kiện xảy ra cùng thị trấn, đặt toạ độ vào ĐÚNG địa điểm sự kiện, hoặc lệch vài trăm mét và hạ `do_tin_cay_toa_do`.
...
⚠️ **Nghiệm thu trình duyệt trong harness này KHÔNG tất định.** Đo được ngày 2026-08-05: 5 lượt chạy cùng một bộ sa đồ cho 0/8/1/2/0 "hỏng", mỗi lượt chỉ ra file khác; `npm run smoke` hỏng lượt đầu rồi 9 đạt/0 hỏng lượt sau; fps hai lượt cùng cấu hình lệch tới 1,9×. Nguyên nhân: swiftshader (GPU phần mềm) + probe chạy đua với chuyển cảnh. **Quy tắc: chạy lại trước khi kết luận có hồi quy, và đừng chọn lượt đẹp nhất để báo cáo.** Tín hiệu đáng tin hơn số đếm: console có sạch không.
