...
| 8 | Thư viện: chế độ đọc kiểu Kindle, chế độ lật, mở rộng cửa sổ, tuỳ chỉnh, bỏ biểu tượng thừa, sắp theo chủ đề + thời gian/tác giả, link trang tỉnh, bổ sung tác phẩm | 🔄 **Dữ liệu nền XONG, UI đang dựng (worktree).** 560/560 mục cũ có `chu_de`; `_chu-de.json` 13 chủ đề (thêm `tho-moi`); **+144 tác phẩm** (44 + 100); 3 file mới `su-ky-dia-chi` · `van-xuoi-hien-thuc-vung-mien` · `tho-moi-lang-man`, đều đã nối vào validator. Nay đã CÓ trục để sắp theo chủ đề. |
