...
const STRICT_SOURCE = new Set([
  ...
  "danh-tuong-khang-chien.json",
  "danh-nhan-cac-trieu.json",
  "chien-dich-tran-danh.json",
  "anh-hung-can-hien-dai.json",
  "trang-nguyen-khoa-bang.json",
  "khoi-nghia-khang-chien.json",
  "danh-nhan-van-hoa-can-hien-dai.json",
  "thanh-hoang-danh-than.json",
  "anh-hung-llvt-cand.json",
  "tuong-linh-hien-dai.json",
  "tien-si-tieu-bieu.json",
  "quan-thanh-liem.json",
  "me-vnah-ahld.json",
  "chien-dich-tran-danh-bo-sung.json",
  "vua-hoang-de.json",
  "vo-tuong-trung-dai.json",
  "van-nghe-si-khoa-hoc.json",
  "tran-danh-khoi-nghia-bo-sung-2.json",
  "chi-si-cach-mang.json",
  "to-nghe-danh-than.json",
  "khoa-bang-bo-sung.json",
  "anh-hung-liet-si-bo-sung.json",
  "vua-chua-bo-sung.json",
  "hoang-toc-tieu-bieu.json",
  "thanh-hoang-vung-mien.json",
  "nha-giao-hoc-gia.json",
  "di-tich-cach-mang.json",
  "nghe-nhan-di-san.json",
  "danh-tuong-chong-phap.json",
  "le-hoi-truyen-thong.json",
  "lang-nghe-truyen-thong.json",
  "danh-thang-di-san-thien-nhien.json",
  "anh-hung-llvt-bo-sung.json",
  "anh-hung-lao-dong-khoa-hoc.json",
  "su-than-ngoai-giao.json",
  "danh-y-luong-y.json",
  "nu-danh-nhan-lich-su.json",
  "doanh-nhan-yeu-nuoc.json",
  ...
  "kien-truc-su-ky-su.json",
  "khoa-bang-bo-sung-3.json",
  "danh-nhan-quan-su-co-trung-dai.json",
  "nha-the-thao-lich-su.json",
  "khoa-bang-bo-sung-4.json",
  "dich-gia-ngon-ngu-hoc.json",
  "thu-linh-khoi-nghia-co-dai.json",
  "khoa-bang-mien-trung.json",
  "danh-nhan-nam-bo.json",
  "danh-than-trieu-nguyen.json",
  "khoa-bang-thanh-hoa.json",
  "nghia-si-can-vuong.json",
  "tri-thuc-khoa-hoc-tk20.json",
  "chua-nguyen-trinh.json",
  "nghe-nhan-lang-nghe-bo-sung.json",
  "khoa-bang-nam-trung-bo.json",
  "danh-nhan-thua-thien-hue.json",
